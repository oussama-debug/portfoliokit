...
export type BookingTypeRow =
  Database["public"]["Tables"]["booking_types"]["Row"];
export type AvailabilityScheduleRow =
  Database["public"]["Tables"]["availability_schedules"]["Row"];
...
export type BookingTypeInsert =
  Database["public"]["Tables"]["booking_types"]["Insert"];
...
export type BookingTypeUpdate =
  Database["public"]["Tables"]["booking_types"]["Update"];
